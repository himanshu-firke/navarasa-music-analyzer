                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-4xl">{primaryRasa.emoji || '🎵'}</span>
                    ...
                    <div className="p-6">
                      <div className="mb-4">
                        <div className="flex items-center text-gray-700 dark:text-gray-300 mb-2">
                          ...
                          <span className="font-semibold truncate">{analysis.filename}</span>
                        </div>
                            ...
                            .map(([emotion, value]) => {
                              ...
                              return (
                                <div key={emotion} className="flex items-center justify-between text-sm">
                                  ...
                                  <span className="font-semibold" style={{ color: rasa.color }}>
                                    {(value * 100).toFixed(0)}%
                                  </span>
                                </div>
                              )
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex-1 flex items-center justify-center px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-lg hover:from-pink-600 hover:to-purple-700 transition-all"
                        >
