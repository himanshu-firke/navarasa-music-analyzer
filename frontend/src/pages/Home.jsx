    ...
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/analyze"
                className="px-8 py-4 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-lg font-semibold hover:scale-105 transition-transform shadow-lg"
              >
                Analyze Your Music
              </Link>
              <Link
                to="/about"
                className="px-8 py-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-lg font-semibold border-2 border-gray-300 dark:border-gray-700 hover:scale-105 transition-transform"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {Object.entries(NAVARASAS).map(([key, rasa], index) => (
              <motion.div
                ...
                className="p-6 rounded-xl bg-gradient-to-br shadow-lg hover:shadow-2xl transition-all cursor-pointer"
                style={{
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <span className="text-4xl">{rasa.emoji}</span>
                </div>
                <p className="text-sm font-semibold mb-2" style={{ color: rasa.color }}>
                  {rasa.english}
                </p>
      ...
      <section className="py-20 bg-gradient-to-r from-pink-500 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            to="/analyze"
            className="inline-block px-8 py-4 bg-white text-purple-600 rounded-lg font-semibold hover:scale-105 transition-transform shadow-xl"
          >
            Start Analyzing Now
          </Link>
        </div>
